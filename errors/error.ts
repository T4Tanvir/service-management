...
class ClientError {
    ...
    static invalidCredentials(): ClientError {
      return new ClientError("The ID or password is incorrect");
    }
    ...
    static notExistsError(name = ""): ClientError {
      return new ClientError(name ? `${name} does not exist` : "Resource does not exist");
    }
    ...
    static accessDeniedError(): ClientError {
      return new ClientError("Sorry, you do not have permission to access this resource");
    }
  }
